...
namespace ChristmasProgram.View
{
    public partial class FIlmShopView : Form
    {
        ...
        private void picBoxStarWars_MouseHover(object sender, EventArgs e)
        {
            ...
            t_Tip.SetToolTip(picBoxMovie1, "Star Wars is an American epic space opera multimedia franchise created by George Lucas," +
        ...
        private void picBoxMenInBlack_MouseHover(object sender, EventArgs e)
        {
            ...
            t_Tip.IsBalloon = true;
            t_Tip.ToolTipIcon = ToolTipIcon.None;
            t_Tip.SetToolTip(picBoxMovie3, "Men in Black follows the exploits of agents Kay (Jones) and Jay (Smith), members of a top-secret organization established to monitor alien activity on Earth. The two MiB find themselves in the middle of the deadly plot by" +
        ...
        private void picBoxHarryPotter_MouseHover(object sender, EventArgs e)
        {
            ...
            t_Tip.IsBalloon = true;
            t_Tip.ToolTipIcon = ToolTipIcon.None;
            t_Tip.SetToolTip(picBoxMovie4, "Harry is an orphan living with his abusive aunt and uncle, Vernon and Petunia Dursley and their bullying son, Dudley. On his eleventh birthday, " +
        ...
        private void picBoxAvatar_MouseHover(object sender, EventArgs e)
        {
            ...
            t_Tip.IsBalloon = true;
            t_Tip.ToolTipIcon = ToolTipIcon.None;
            t_Tip.SetToolTip(picBoxMovie5, "Pandora, whose atmosphere is inhospitable to humans, is inhabited by the Na'vi, 10-foot-tall (3.0 m), blue-skinned, sapient humanoids that live in harmony with nature. To explore Pandora, genetically matched human scientists use Na'vi-human hybrids called Avatars");
        }
        ...
        private void picBoxAvengers_MouseHover(object sender, EventArgs e)
        {
            ...
            t_Tip.IsBalloon = true;
            t_Tip.ToolTipIcon = ToolTipIcon.None;
            t_Tip.SetToolTip(picBoxMovie6, "Earth's Mightiest Heroes stand as the planet's first line of defense against the most powerful threats in the universe. The Avengers began as a group of extraordinary individuals who " +
        ...
        private void FIlmShopView_Load(object sender, EventArgs e)
        {
            ...
            var trendMovies = client.GetTrendingMoviesAsync(TimeWindow.Day).Result.Results;

            for (int i = 0; i < 6; i++)
            {
                Movie movie = client.GetMovieAsync(trendMovies[i].Id).Result;
